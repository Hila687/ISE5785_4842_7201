...
class LightsTests {
   ...
   /**
    * Test rendering a sphere illuminated by multiple light sources simultaneously:
    * directional, point, and spotlight.
    * The lights are configured with different positions, colors, and directions.
    * This test demonstrates the combined lighting effects on a single sphere.
    * All geometry parameters remain unchanged as required by the instructions.
    */
   @Test
   void sphereMultipleLights() {
      ...
      scene1.lights.add(
              new DirectionalLight(new Color(400, 300, 300), new Vector(-1, 0, -1))
      );
   ...
   /**
    * Test rendering a pair of triangles illuminated by three different light sources:
    * directional, point, and spotlight.
    * The test ensures that the combined contribution of all light types is visible,
    * with clearly distinguishable highlights and shadows.
    * Triangle definitions are not modified, in accordance with the instructions.
    */
   @Test
   void trianglesMultipleLights() {
      ...
      scene2.lights.add(
              new DirectionalLight(new Color(200, 300, 150), new Vector(-1, -1, -1))
      );
