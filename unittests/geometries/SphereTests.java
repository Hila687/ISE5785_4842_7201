...
//        assertEquals(null, sphere.findIntersections(new Ray(new Point(2, 0, 0), new Vector(1, 1, 0))),
//                "Ray's line out of sphere");
//
//        // TC02: Ray starts before and crosses the sphere (2 points)
//        Point p1 = new Point(1, 1, 0);
//        Point p2 = new Point(1, -1, 0);
//        assertEquals(p1, sphere.findIntersections(new Ray(new Point(0, 0, 0), new Vector(1, 1, 0))).get(0).point,
//                "Wrong intersection point");
//        assertEquals(p2, sphere.findIntersections(new Ray(new Point(0, 0, 0), new Vector(1, 1, 0))).get(1).point,
//                "Wrong intersection point");
//
//        // TC03: Ray starts inside the sphere (1 point)
//        Point p3 = new Point(1, 1, 0);
//        assertEquals(p3, sphere.findIntersections(new Ray(new Point(1, 0, 0), new Vector(1, 1, 0))).get(0).point,
//                "Wrong intersection point");
//
//        // TC04: Ray starts after the sphere (0 points)
//        assertEquals(null, sphere.findIntersections(new Ray(new Point(2, 0, 0), new Vector(1, 0, 0))),
//                "Ray's line out of sphere");
//
//        // =============== Boundary Values Tests ==================
//
//        // TC11: Ray's line is on the sphere (0 points)
//        assertEquals(null, sphere.findIntersections(new Ray(new Point(1, 1, 0), new Vector(1, 0, 0))),
//                "Ray's line out of sphere");
//
//        // TC12: Ray's line is inside the sphere (0 points)
//        assertEquals(null, sphere.findIntersections(new Ray(new Point(1, 0, 0), new Vector(0, 1, 0))),
//                "Ray's line out of sphere");
//
//        // TC13: Ray's line is outside the sphere (0 points)
//        assertEquals(null,
//    }
